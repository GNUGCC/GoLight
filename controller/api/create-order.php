        ...
        if (is_array($list)) {
            ...
            foreach ($list as $row) {
                if (@$row['checked']) {
                    ...
                    if (!strlen($item['name']) || !strlen($item['birthday']) || !strlen($item['phone']) || !strlen($item['address']) || !strlen($item['pet_image'])) {
                ...
                $attachTemp = Attachment::from('', $item['pet_image'], '');
                if($attachTemp !== null) {
                    $item['pet_image'] = $attachTemp;    
                }
                $items[] = $item;
            }
        }
